...
const hashPassword = (plainTextPassword) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bcrypt_1.default.hash(plainTextPassword, config_1.default.BCRYPT_SALT_ROUNDS);
});
const comparePassword = (plainTextPassword, hashPassword) => __awaiter(void 0, void 0, void 0, function* () {
